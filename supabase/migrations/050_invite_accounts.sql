...
-- ---------------------------------------------------------------------------
-- НИЖЕ замените +79991234567 на реальный номер из .env (INVITE_ACCOUNT_PHONE)
INSERT INTO public.invite_accounts (phone, label, is_default)
VALUES ('+79991234567', 'Основной аккаунт', true)
