-- Combined migrations for podryad-pro-test
-- Apply in: https://supabase.com/dashboard/project/gkoxehnuvyqccuwasrhg/sql/new
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('001_initial_schema', '001_initial_schema.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('002_add_worker_fields', '002_add_worker_fields.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('003_add_user_email_fields', '003_add_user_email_fields.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('004_material_requests', '004_material_requests.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('005_marketplace', '005_marketplace.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('006_escrow', '006_escrow.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('007_catalog', '007_catalog.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('008_orders_markup', '008_orders_markup.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('009_leads', '009_leads.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('010_payout_method', '010_payout_method.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('011_contractors_tokens', '011_contractors_tokens.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('012_leads_address_contacts', '012_leads_address_contacts.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('013_crm_agent', '013_crm_agent.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('013_executor_responses', '013_executor_responses.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('014_crm_rag', '014_crm_rag.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('015_contractors_brigade', '015_contractors_brigade.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('016_customers', '016_customers.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('017_manual_payment', '017_manual_payment.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('018_cleanup_escrow', '018_cleanup_escrow.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('019_drop_escrow_ledger', '019_drop_escrow_ledger.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('020_fix_order_statuses', '020_fix_order_statuses.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('021_add_missing_indexes', '021_add_missing_indexes.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('022_own_equipment', '022_own_equipment.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('023_fix_status_constraint', '023_fix_status_constraint.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('024_site_images', '024_site_images.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('025_db_audit_fixes', '025_db_audit_fixes.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('026_rls_hardening', '026_rls_hardening.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('027_job_queue', '027_job_queue.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('028_max_crosspost_tracking', '028_max_crosspost_tracking.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('029_job_queue_maintenance', '029_job_queue_maintenance.sql') ON CONFLICT DO NOTHING;
...
INSERT INTO supabase_migrations.schema_migrations (version, name) VALUES ('030_payment_gateway_scaffold', '030_payment_gateway_scaffold.sql') ON CONFLICT DO NOTHING;
