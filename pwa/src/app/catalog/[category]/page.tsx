...
const LABOR_SERVICES: CatalogItem[] = [
  { id: 'l-1', image: '', title: 'Грузчики', description: 'Погрузка, разгрузка, перенос мебели и стройматериалов. Бригады от 2 человек.', price: 350, unit: 'ч' },
  { id: 'l-2', image: '', title: 'Разнорабочие', description: 'Подсобные работы на стройке, уборка территории, демонтаж.', price: 300, unit: 'ч' },
  { id: 'l-3', image: '', title: 'Благоустройство участков', description: 'Покос травы, уборка мусора, планировка территории, мощение.', price: 250, unit: 'ч' },
  { id: 'l-4', image: '', title: 'Строители / ремонт', description: 'Кладка, штукатурка, плитка, электрика, сантехника. Бригады с опытом от 5 лет.', price: 500, unit: 'ч' },
  { id: 'l-5', image: '', title: 'Землекопы', description: 'Копка траншей, ям, котлованов вручную. Работа в стеснённых условиях.', price: 350, unit: 'ч' },
  { id: 'l-6', image: '', title: 'Дворники / уборщики', description: 'Уборка подъездов, территории, мытьё окон и фасадов.', price: 250, unit: 'ч' },
];
