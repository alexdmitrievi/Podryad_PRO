    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mb-10">
          ...
          <h3 className="font-heading text-base font-bold text-gray-800 mb-2 mt-4">
            7.1. Платёжные реквизиты
          </h3>
          <p className="text-gray-700 leading-relaxed mb-4">
            Оплата производится напрямую по реквизитам: СБП (Система быстрых платежей) или
            безналичный перевод по счёту организации. Реквизиты предоставляются менеджером
            в рамках каждой заявки. Третьи стороны для приёма платежей не привлекаются.
          </p>
