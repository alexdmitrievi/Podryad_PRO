...
const SERVICES = [
  { emoji: '🌿', title: 'Покос, аэрация и скарификация газона', desc: 'Профессиональный уход за газоном любой площади. Выезд, оценка, работа в день обращения.' },
  { emoji: '🚜', title: 'Расчистка территорий под строительство', desc: 'Полная подготовка участка: вывоз мусора, планировка, корчевание. Техника и бригада в одном заказе.' },
  { emoji: '🪓', title: 'Корчевание пней и спил деревьев', desc: 'Удаление деревьев любой сложности. Спил, корчевание, вывоз порубочных остатков.' },
  { emoji: '🌾', title: 'Покос высокой травы и сорняка любого вида', desc: 'Бензокосы, райдеры, тракторные косилки. Любой рельеф и густота.' },
  { emoji: '🏊', title: 'Сборка и чистка бассейнов', desc: 'Расконсервация, сборка каркасных и надувных бассейнов, химчистка, подготовка к сезону.' },
  { emoji: '🔥', title: 'Любые сварочные работы', desc: 'Аттестованные сварщики NAKS. Монтаж металлоконструкций, ворота, заборы, навесы.' },
  { emoji: '🔧', title: 'Ремонтные работы жилой и коммерческой недвижимости', desc: 'Косметический и капитальный ремонт. Квартиры, офисы, торговые площади — под ключ.' },
  { emoji: '🏠', title: 'Строительство домов под ключ', desc: 'От фундамента до чистовой отделки. Проектирование, материалы, бригады — полный цикл.' },
  { emoji: '📅', title: 'Абонентское обслуживание участков и территорий под ключ', desc: 'Постоянный уход за территорией. Покос, уборка, мелкий ремонт, вывоз мусора — по графику.' },
];

const MATERIALS = [
  { emoji: '🏗️', title: 'Бетон', desc: 'Бетон любых марок: M100–M400. Доставка миксером.' },
  { emoji: '🪨', title: 'Щебень', desc: 'Щебень всех фракций: 5–20, 20–40, 40–70, гранитный, гравийный.' },
  { emoji: '🏖️', title: 'Песок', desc: 'Песок карьерный, речной, мытый, строительный.' },
  { emoji: '🧱', title: 'Кирпич', desc: 'Кирпич рядовой, облицовочный, силикатный, керамический.' },
  { emoji: '📦', title: 'Цемент', desc: 'Цемент M400, M500. В мешках 25/50 кг или россыпью.' },
];
