    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-white/95 dark:bg-dark-card/95 backdrop-blur-md border-b border-gray-100/80 dark:border-dark-border shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <a
            href="/order/new"
            className="hidden sm:inline-flex btn-shine bg-brand-500 hover:bg-brand-600 text-white font-bold text-sm px-5 py-2.5 rounded-xl transition-all hover:shadow-glow cursor-pointer"
          >
            Разместить заказ
          </a>
          {/* Mobile: hamburger */}
