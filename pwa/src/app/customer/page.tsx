            ...
            <div className="bg-white dark:bg-dark-card rounded-3xl p-5 shadow-card border border-gray-100 dark:border-dark-border">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                    Бот пришлёт точную стоимость. Оплатите картой, через СБП
                    или по реквизитам компании (безналичная оплата для организаций и ИП).
                    Заказ опубликуется в канале, исполнитель откликнется — вы получите уведомление.
                  </p>
                </div>
              </div>
            </div>
