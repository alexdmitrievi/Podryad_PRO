...
export const metadata: Metadata = {
  title: 'Подряд PRO в MAX — работа и подработка Омск без VPN',
  description: 'Заказы на грузчиков, уборку, строительство в Омске. Канал в мессенджере MAX — работает без VPN на территории РФ.',
  keywords: 'работа омск max, подработка max мессенджер, грузчики омск, подряд pro max, работа без vpn',
  openGraph: {
    title: 'Подряд PRO в MAX — работа Омск без VPN',
    description: 'Заказы на грузчиков, уборку, строительство. Канал в MAX — работает без VPN.',
    type: 'website',
      ...
      <section className="bg-gradient-to-br from-max via-max to-max-dark text-white px-6 pt-12 pb-16 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-md mx-auto space-y-5">
          ...
          <p className="text-white/80 max-w-xs mx-auto leading-relaxed">
            Все заказы на грузчиков, уборку и строительство в Омске — 
