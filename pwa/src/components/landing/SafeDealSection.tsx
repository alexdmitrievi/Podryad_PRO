...
const customerSteps = [
  {
    icon: Lock,
    label: 'Оплачиваете счёт',
    desc: 'Деньги поступают на счёт платформы — исполнитель их ещё не получил',
  },
  {
    icon: HardHat,
    label: 'Работа выполнена',
    desc: 'Исполнитель сдаёт работу — средства по-прежнему у нас',
  },
  {
    icon: CheckCircle2,
    label: 'Подтверждаете — выплата',
    desc: 'Нажмите «Принять» — мы перечисляем оплату исполнителю',
  },
];
        ...
        <ScrollReveal delay={0}>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 dark:text-dark-muted mt-3 max-w-xl mx-auto">
              Деньги хранятся на счёте платформы до сдачи работ — выплачиваем исполнителю только после вашего «ОК»
            </p>
          </div>
        </ScrollReveal>
